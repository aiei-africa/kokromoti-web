...
// no year selector. Older years become reachable later via a constituency's
// Hist. Trend tab, not a top-level dropdown.
export const CURRENT_ELECTION_CODE = "2024";
